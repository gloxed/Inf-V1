if shared.infExecuted then
	local VERSION = "1.02"..(shared.infPrivate and " PRIVATE" or "")
	local customdir = (shared.infPrivate and "infprivate/" or "inf/")
	...
	local api = {
		...
		["RainbowSpeed"] = 0.6,
		["Language"] = betterisfile("inf/language.dat") and readfile("inf/language.dat") or "en-us",
	...
	local function GetURL(scripturl)
		if shared.infDeveloper then
			if not betterisfile("inf/"..scripturl) then
				error("File not found : inf/"..scripturl)
			end
			return readfile("inf/"..scripturl)
		else
			local res = game:HttpGet("https://raw.githubusercontent.com/gloxed/Inf-V1/main/"..scripturl, true)
	...
	--local translatedlogo, res = pcall(function() return GetURL("translations/"..api["Language"].."/infLogo1.png") end)
	...
	local function getcustomassetfunc(path)
		if not betterisfile(path) then
			spawn(function()
				...
				textlabel.Text = "Installing "..path.." | Inf"
			...
			local req = requestfunc({
				Url = "https://raw.githubusercontent.com/gloxed/Inf-V1/main/"..path:gsub("inf/assets", "assets"),
				Method = "GET"
			})
	...
	searchbaricon.Image = getcustomassetfunc("inf/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = getcustomassetfunc("inf/assets/WindowBlur.png")
	...
	hoverboxshadow.Image = getcustomassetfunc("inf/assets/WindowBlur.png")
	...
	api["SaveSettings"] = function()
		if loadedsuccessfully then
			writefile(customdir.."Profiles/"..(shared.CustomSaveinf or game.PlaceId)..".infprofiles.txt", game:GetService("HttpService"):JSONEncode(api["Profiles"]))
			local WindowTable = {}
			...
			writefile(customdir.."Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveinf or game.PlaceId)..".infprofile.txt", game:GetService("HttpService"):JSONEncode(api["Settings"]))
			writefile(customdir.."Profiles/"..(game.GameId).."GUIPositions.infprofile.txt", game:GetService("HttpService"):JSONEncode(WindowTable))
		end
	end
	...
	api["LoadSettings"] = function(customprofile)
		if identifyexecutor and identifyexecutor():find("ScriptWare") == nil and listfiles then
			for i,v in pairs(listfiles(customdir.."Profiles")) do 
				...
				if (ext and ext:find("infprofile") and ext:find("txt") == nil) then
		...
		if betterisfile("inf/Profiles/GUIPositions.infprofile.txt") and game.GameId == 2619619496 then
			writefile("inf/Profiles/"..(game.GameId).."GUIPositions.infprofile.txt", readfile("inf/Profiles/GUIPositions.infprofile.txt"))
			if delfile then delfile("inf/Profiles/GUIPositions.infprofile.txt") end
		end
		if shared.infPrivate then
			if betterisfile("infprivate/Profiles/"..(game.GameId).."GUIPositions.infprofile.txt") == false and betterisfile("inf/Profiles/"..(game.GameId).."GUIPositions.infprofile.txt") then
				writefile("infprivate/Profiles/"..(game.GameId).."GUIPositions.infprofile.txt", readfile("inf/Profiles/"..(game.GameId).."GUIPositions.infprofile.txt"))
			end
			if betterisfile("infprivate/Profiles/"..(shared.CustomSaveinf or game.PlaceId)..".infprofiles.txt") == false and betterisfile("inf/Profiles/"..(shared.CustomSaveinf or game.PlaceId)..".infprofiles.txt") then
				writefile("infprivate/Profiles/"..(shared.CustomSaveinf or game.PlaceId)..".infprofiles.txt", readfile("inf/Profiles/"..(shared.CustomSaveinf or game.PlaceId)..".infprofiles.txt"))
			end
			if betterisfile("infprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveinf or game.PlaceId)..".infprofile.txt") == false and betterisfile("inf/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveinf or game.PlaceId)..".infprofile.txt") then
				writefile("infprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveinf or game.PlaceId)..".infprofile.txt", readfile("inf/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveinf or game.PlaceId)..".infprofile.txt"))
			end
		end
		local success2, result2 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(shared.CustomSaveinf or game.PlaceId)..".infprofiles.txt"))
		end)
		...
		local success3, result3 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(game.GameId).."GUIPositions.infprofile.txt"))
		end)
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveinf or game.PlaceId)..".infprofile.txt"))
		end)
	...
	api["SwitchProfile"] = function(profilename)
		...
		if (not betterisfile(customdir.."Profiles/"..(profilename == "default" and "" or profilename)..(shared.CustomSaveinf or game.PlaceId)..".infprofile.txt")) then
			local realprofile = api["CurrentProfile"]
			api["CurrentProfile"] = profilename
			api["SaveSettings"]()
			api["CurrentProfile"] = realprofile
		end
		local infprivate = shared.infePrivate
		local oldindependent = shared.infIndependent
		api["SelfDestruct"]()
		if not oldindependent then
			shared.infSwitchServers = true
			shared.infOpenGui = (clickgui.Visible)
			shared.infPrivate = infprivate
	...
	api["CreateMainWindow"] = function()
		...
		windowshadow.Image = getcustomassetfunc("inf/assets/WindowBlur.png")
		...
		windowlogo1.Image = getcustomassetfunc(translatedlogo and "inf/translations/"..api["Language"].."/InfLogo1.png" or "inf/assets/InfLogo1.png")
		...
		windowlogo2.Image = getcustomassetfunc("inf/assets/InfLogo2.png")
		...
		settingswheel.Image = getcustomassetfunc("inf/assets/SettingsWheel1.png")
		...
		discordbutton.Image = getcustomassetfunc("inf/assets/DiscordIcon.png")
		...
		settingsexit.Image = getcustomassetfunc("inf/assets/ExitIcon1.png")
		...
		overlaysicon.Image = getcustomassetfunc("inf/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = getcustomassetfunc("inf/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = getcustomassetfunc("inf/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = getcustomassetfunc("inf/assets/BackIcon.png")
		...
		windowapi["CreateCustomToggle"] = function(argstable)
			...
			api["ObjectsThatCanBeSaved"]["infSettings"..argstable["Name"].."Toggle"] = {["Type"] = "Toggle", ["Object"] = buttontext, ["Api"] = buttonapi}
			return buttonapi
		end
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = getcustomassetfunc("inf/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = getcustomassetfunc("inf/assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = getcustomassetfunc("inf/assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = getcustomassetfunc("inf/assets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindimg.Image = getcustomassetfunc("inf/assets/KeybindIcon.png")
			...
			bindtext2.Image = getcustomassetfunc("inf/assets/BindBackground.png")
			...
			bindbkg.MouseEnter:Connect(function() 
				bindimg.Image = getcustomassetfunc("inf/assets/PencilIcon.png") 
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = getcustomassetfunc("inf/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = getcustomassetfunc("inf/assets/ColorSlider1.png")
			...
			sliderapi["Object"] = frame
			sliderapi["SetValue"] = function(val)
				slider3.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("inf/assets/ColorSlider2.png") or getcustomassetfunc("inf/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("inf/assets/RainbowIcon2.png") or getcustomassetfunc("inf/assets/RainbowIcon1.png"))
			...
			sliderapi["SetRainbow"] = function(val)
				...
				if sliderapi["RainbowValue"] then
					...
					heh = coroutine.resume(coroutine.create(function()
						...
						until sliderapi["RainbowValue"] == false or shared.infExecuted == nil
					end))
				end
			end
	...
	api["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = getcustomassetfunc("inf/assets/PinButton.png")
		...
		optionsbutton.Image = getcustomassetfunc("inf/assets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = getcustomassetfunc("inf/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = getcustomassetfunc("inf/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = getcustomassetfunc((argstable["Name"] == "ProfilesList" and "inf/assets/TextBoxBKG2.png" or "inf/assets/TextBoxBKG.png"))
				...
				addbutton.Image = getcustomassetfunc("inf/assets/AddItem.png")
				...
				textapi["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textapi["ObjectList"]) do
						...
						deletebutton.Image = getcustomassetfunc("inf/assets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = getcustomassetfunc("inf/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = getcustomassetfunc("inf/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	api["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = getcustomassetfunc("inf/assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = getcustomassetfunc("inf/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = getcustomassetfunc("inf/assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = getcustomassetfunc("inf/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = getcustomassetfunc("inf/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["Players"] = windowapi["CreateButton"]({
					...
					["Icon"] = "inf/assets/TargetIcon1.png",
					["IconSize"] = 15,
				...
				buttonreturned["NPCs"] = windowapi["CreateButton"]({
					...
					["Icon"] = "inf/assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowapi["CreateButton"]({
					...
					["Icon"] = "inf/assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = "inf/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonapi["CreateColorSlider"] = function(argstable)
				...
				sliderexpand.Image = getcustomassetfunc("inf/assets/HoverArrow3.png")
				sliderexpand.Parent = frame
				sliderexpand.MouseEnter:Connect(function()
					sliderexpand.Image = getcustomassetfunc("inf/assets/HoverArrow4.png")
				end)
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = getcustomassetfunc("inf/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = getcustomassetfunc("inf/assets/SliderArrow1.png")
	...
	api["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = getcustomassetfunc("inf/assets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, game:GetService("TextService"):GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = getcustomassetfunc("inf/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:Connect(function()
				sliderexpand.Image = getcustomassetfunc("inf/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:Connect(function()
				sliderexpand.Image = getcustomassetfunc("inf/assets/HoverArrow.png")
			end)
	...
	api["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = getcustomassetfunc("inf/assets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = getcustomassetfunc("inf/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = getcustomassetfunc(customicon and "inf/"..customicon or "inf/assets/InfoNotification.png")
	...
	api["LoadedAnimation"] = function(enabled)
		if enabled then
			api["CreateNotification"]("Finished Loading", "Press "..string.upper(api["GUIKeybind"]).." to open GUI | Inf", 9.5)
		end
	end
